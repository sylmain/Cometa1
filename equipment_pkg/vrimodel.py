...
class VriModel(QAbstractTableModel):
    ...
    def get_vri_info(self, mi_id: int, vri_id: int) -> dict:
        """
        Возвращает словарь с информацией о выбранной поверке из таблицы vri
        :param mi_id, vri_id:
        :return:
        """
        if mi_id in self.vri_dict and vri_id in self.vri_dict[mi_id]:
            return self.vri_dict[mi_id][vri_id]
        return {}
